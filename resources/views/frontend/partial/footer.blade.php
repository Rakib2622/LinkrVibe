            ...
            <div class="footer-top">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                        ...
                        <ul>
                            <li><a href="{{ route('about') }}">Digital Business Card</a></li>
                            <li><a href="{{ route('about') }}">NFC &amp; QR Menu</a></li>
                            <li><a href="{{ route('about') }}">Google Review Card</a></li>
...
{{-- <div class="newsletter-wrap" id="popup-container">
  <div id="popup-window">
    ...
    <div class="display-table splash-bg">
      <div class="display-table-cell width40"><img src="/home/assets/images/newsletter-img.jpg" alt="Join Our Mailing List" title="Join Our Mailing List" /> </div>
