<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <script>document.write(new Date().getFullYear())</script> LinkrVibe.
            </div>
...
<script src="/dash/assets/js/waves.min.js"></script>
<script src="/dash/assets/js/feather.min.js"></script>
<!-- pace js -->
<script src="/dash/assets/js/pace.min.js"></script>

<!-- apexcharts -->
<script src="/dash/assets/js/apexcharts.min.js"></script>

<!-- Plugins js-->
<script src="/dash/assets/js/jquery-jvectormap-1.2.2.min.js"></script>
<script src="/dash/assets/js/jquery-jvectormap-world-mill-en.js"></script>
<!-- dashboard init -->
